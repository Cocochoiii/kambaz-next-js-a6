  ...
  return (
      <div id="wd-lab1">
        ...
        <div id="wd-h-tag">
          ...
          topics such as HTML Documents, HTML Tags, Heading Tags, etc. HTML heading tags can be used to render
          large headings. There are 6 heading tags: h1..h6. Tag h1 is the largest and h6 is the smallest.
        </div>
        ...
        <div id="wd-p-tag">
          ...
          <p id="wd-p-1">
            ...
            text easier to read. Browsers ignore vertical white spaces and render all the text as one single set
        ...
        <div id="wd-tables">
          ...
          <table border={1} width="100%">
            ...
            <tr><td>Q5</td><td>Next.js</td><td>3/3/21</td><td>92</td></tr>
            <tr><td>Q6</td><td>Node.js</td><td>3/10/21</td><td>91</td></tr>
            <tr><td>Q7</td><td>APIs</td><td>3/17/21</td><td>89</td></tr>
            <tr><td>Q8</td><td>MongoDB</td><td>3/24/21</td><td>94</td></tr>
            <tr><td>Q9</td><td>Redux</td><td>3/31/21</td><td>87</td></tr>
            <tr><td>Q10</td><td>Deployment</td><td>4/7/21</td><td>93</td></tr>
            </tbody>
            <tfoot>
        ...
        <div id="wd-forms">
          ...
          <form id="wd-text-fields">
            ...
            <h5>Upload</h5>
            <label htmlFor="wd-file">Profile picture:</label>
            <input type="file" id="wd-file" /><br/>
            ...
            <input type="checkbox" name="check-genre" id="wd-chkbox-fantasy"/><label htmlFor="wd-chkbox-fantasy">Fantasy</label><br/>
